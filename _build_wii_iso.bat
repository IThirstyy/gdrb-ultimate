...
del "%~dp0\iso\GDRB Ultimate.iso"
"%~dp0dependencies/wit/wit" copy "%~dp0\_build\wii" "%~dp0\iso\GDRB Ultimate.iso"

GDRB ultimate should've successfully built. copy the iso to your console to play. enjoy :)
