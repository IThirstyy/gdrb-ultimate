...
rm ./iso/GDRB\ Ultimate.wbfs
dependencies/wit/wit copy ./_build/wii ./iso/GDRB\ Ultimate.wbfs

echo "GDRB ultimate should've successfully built. copy the wbfs to your console to play. enjoy :)"